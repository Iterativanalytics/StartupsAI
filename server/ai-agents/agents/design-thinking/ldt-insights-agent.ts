...
/**
 * AI-Powered Lean Design Thinking™ Insights Agent
 * 
 * This agent embodies the methodology's evidence-based approach by specializing in:
 * - Pattern recognition in empathy data (Design Thinking foundation)
 * - Cross-phase insight connections (Methodology bridge)
 * - Automated insight synthesis (Lean Startup core)
 * - Insight evolution tracking (Evidence-based learning)
 * - Business impact assessment (Strategic validation)
 */
