...
export class RIASECInterpreter {
   ...
   */
  private analyzeStartupFit(scores: RIASECScores, code: string): StartupFit {
    const idealRoles = getStartupRoles(code, scores);
   ...
   */
  private identifyStartupStrengths(scores: RIASECScores, code: string): string[] {
   ...
   */
  private identifyStartupChallenges(scores: RIASECScores, code: string): string[] {
   ...
   */
  private determineWorkEnvironment(scores: RIASECScores, code: string): WorkEnvironmentPreferences {
   ...
   */
  private inferDecisionMakingStyle(scores: RIASECScores): string {
