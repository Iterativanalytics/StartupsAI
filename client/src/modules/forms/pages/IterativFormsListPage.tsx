...
interface IterativFormsListPageProps {
...
const IterativFormsListPage: React.FC<IterativFormsListPageProps> = ({ applications, onSelectApplication }) => {
...
export default IterativFormsListPage;