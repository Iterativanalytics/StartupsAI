...
interface IterativDeckAITemplate {
  id: string;
  name: string;
  description: string;
  ...
  color: string;
  slides: Partial<IterativDeckSlide>[];
}

interface IterativDeckDocumentUpload {
  file: File;
