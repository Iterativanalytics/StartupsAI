...
import FundingHubHeader from '@/components-hub/FundingHubHeader';
import { 
  ...
  Eye, Lock, Zap, ShieldCheck, Sun, Moon, Sparkles
} from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mb-12 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm border-0 shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Real outcomes from our funding platform
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">Companies Funded</div>
              </div>
              <div className="text-center">
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Discover the perfect funding solution for your business stage and goals
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="backdrop-blur-sm bg-white/50 dark:bg-gray-900/50 border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
              <CardContent className="p-6 text-center">
                <div className="p-3 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 text-white w-16 h-16 mx-auto mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <DollarSign className="h-8 w-8" />
                </div>
                <h3 className="text-lg font-semibold mb-2 text-gray-800 dark:text-gray-200">Equity Funding</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Sell ownership shares to investors in exchange for capital</p>
            ...
            <Card className="backdrop-blur-sm bg-white/50 dark:bg-gray-900/50 border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
              <CardContent className="p-6 text-center">
                <div className="p-3 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white w-16 h-16 mx-auto mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <CreditCard className="h-8 w-8" />
                </div>
                <h3 className="text-lg font-semibold mb-2 text-gray-800 dark:text-gray-200">Debt Funding</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Borrow money that must be repaid with interest over time</p>
                <div className="text-xs text-gray-500 dark:text-gray-500">
                  <div className="flex justify-between mb-1">
                    <span>Best for:</span>
            ...
            <Card className="backdrop-blur-sm bg-white/50 dark:bg-gray-900/50 border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
              <CardContent className="p-6 text-center">
                <div className="p-3 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white w-16 h-16 mx-auto mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <Gift className="h-8 w-8" />
                </div>
                <h3 className="text-lg font-semibold mb-2 text-gray-800 dark:text-gray-200">Grant Funding</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Non-repayable funds for specific projects or demographics</p>
                <div className="text-xs text-gray-500 dark:text-gray-500">
                  <div className="flex justify-between mb-1">
                    <span>Best for:</span>
                    <span>Non-profits & research</span>
                  </div>
                  <div className="flex justify-between mb-1">
                    <span>Typical range:</span>
                    <span>$5K - $500K</span>
            ...
            <Card className="backdrop-blur-sm bg-white/50 dark:bg-gray-900/50 border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
              <CardContent className="p-6 text-center">
                <div className="p-3 rounded-full bg-gradient-to-r from-orange-500 to-red-500 text-white w-16 h-16 mx-auto mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <Search className="h-8 w-8" />
                </div>
                <h3 className="text-lg font-semibold mb-2 text-gray-800 dark:text-gray-200">Match Funding</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">AI-powered tool to find your perfect funding match</p>
                <div className="text-xs text-gray-500 dark:text-gray-500">
                  <div className="flex justify-between mb-1">
                    <span>Best for:</span>
          ...
          {/* Quick Action Bar */}
          <Card className="backdrop-blur-sm bg-gradient-to-r from-purple-50 to-teal-50 dark:from-purple-900/20 dark:to-teal-900/20 border-0 shadow-lg">
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-center md:text-left">
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Ready to Get Started?</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Choose a funding type below to explore detailed options and requirements</p>
                </div>
                <div className="flex gap-2">
                  ...
                  <Button 
                    variant="outline" 
                    onClick={() => setLocation('/funding/equity')}
        ...
        <Tabs value={id || 'equity'} onValueChange={(value) => setLocation(`/funding/${value}`)} className="space-y-6">
          <div className="flex justify-center mb-8">
            <TabsList className="grid w-full max-w-lg grid-cols-4 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm border-0">
              <TabsTrigger 
                value="equity" 
                className="flex items-center gap-2 data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-teal-500 data-[state=active]:text-white"
              >
          ...
          <TabsContent value="equity" className="space-y-6">
            ...
            <div className="grid gap-6">
              {filteredInvestors.map((investor) => (
                <Card key={investor.id} className="backdrop-blur-sm bg-white/50 dark:bg-gray-900/50 border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <CardContent className="p-6">
          ...
          <TabsContent value="debt" className="space-y-6">
            ...
            <Tabs value={selectedBureau} onValueChange={setSelectedBureau} className="mb-6">
              <div className="flex justify-center">
                <TabsList className="grid grid-cols-3 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm border-0">
                  <TabsTrigger 
                    value="transunion" 
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">$1,508 / $84,301</p>
                    </div>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">Always on time</p>
                    </div>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">Open & closed</p>
                    </div>
          ...
          <TabsContent value="grants" className="space-y-6">
            ...
            <div className="grid gap-6">
              {filteredGrants.map((grant) => (
                <Card key={grant.id} className="backdrop-blur-sm bg-white/50 dark:bg-gray-900/50 border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <CardContent className="p-6">
          ...
          <TabsContent value="matcher" className="space-y-6">
            <Card className="backdrop-blur-sm bg-white/50 dark:bg-gray-900/50 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardHeader>
                ...
                <CardDescription className="text-gray-600 dark:text-gray-400">
                  AI-powered tool to find the perfect funding options for your business
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-teal-600 mb-2">How it works</h4>
                    <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                      <li>• Answer a few questions about your business</li>
                      <li>• AI analyzes your profile and requirements</li>
                      <li>• Get personalized funding recommendations</li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                      <li>• Save time researching funding options</li>
                      <li>• Get matched with relevant opportunities</li>
                      <li>• Understand requirements upfront</li>
                ...
                <div className="bg-gradient-to-r from-teal-50 to-blue-50 dark:from-teal-900/20 dark:to-blue-900/20 p-6 rounded-lg">
                  <h3 className="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200">Start Your Funding Match</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                    Tell us about your business and we'll find the best funding options for you.
                  </p>
                  <div className="space-y-4">
                    <div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="backdrop-blur-sm bg-white/50 dark:bg-gray-900/50 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Funding Sources</div>
                </CardContent>
              </Card>
              <Card className="backdrop-blur-sm bg-white/50 dark:bg-gray-900/50 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-6 text-center">
                  <div className="text-2xl font-bold text-purple-600 mb-2">5 min</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Average Match Time</div>
                </CardContent>
              </Card>
            </div>
          </TabsContent>
